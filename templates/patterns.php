...
Данный шаблон проектирования подходит для применения фрэймворков на стороне клиента. Например, React.js и Angular.js позволяют писать код как на MVC, так и на MV-VM.
